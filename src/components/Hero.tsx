    ...
    <section className="relative min-h-[85vh] md:min-h-screen flex items-center justify-center bg-grid overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 pt-16 text-center">
        ...
        >
          ...
          <a
            href="#contact"
            className="px-8 py-3 rounded-lg border border-border text-foreground font-medium hover:border-accent hover:text-accent transition-colors"
          >
            Get In Touch
          </a>
        </motion.div>
        ...
        >
          ...
          <a
            href="https://www.linkedin.com/in/eric-terlop/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted hover:text-accent-light transition-colors"
            aria-label="LinkedIn"
